...
if ENV_FILE.is_file():
    spec = importlib.util.spec_from_file_location('env', str(ENV_FILE))
...
# Server-side AI configuration (set via Heroku config vars in production)
